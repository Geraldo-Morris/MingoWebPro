...
import ff3 from "../Images/valo/Rectangle 6.png";
import rr16 from "../Images/valo/Rectangle 16.png";
import rr17 from "../Images/valo/Rectangle 17.png";
import rr18 from "../Images/valo/Rectangle 18.png";
      ...
      <div>
        ...
        <div className="relative">
          ...
          <div className="absolute top-0 inset-0 flex items-center justify-center flex-col">
            <a
              href="https://www.youtube.com/watch?v=Wrdh5HrOCMc"
              target="_blank"
            >
              <img src={play} alt="" />
            </a>
        ...
        <div className="flex justify-between mx-auto w-max mt-[50px] mb-[30px]">
          {/* section 2 */}
          <div className="text-white  mr-[250px]">
            <h1 className="text-[54px] font-bold">Valorant</h1>
            <div className="flex">
            ...
            <h1 className="font-light text-[18px] mt-[20px]">
              Valorant is a FPS game developed and published by Riot Games and{" "}
              <br />
              features 2 teams of five players competing against each other in a
              match.
            </h1>
            ...
            <div className="flex gap-[50px] my-[20px]">
              ...
              <div className="flex-col">
                ...
                <a
                  ...
                  href="https://store.epicgames.com/en-US/p/valorant"
                  target="_blank"
                >
                  PC
                </a>
