...
import ff3 from "../Images/streetfighter6/Rectangle 6.png";
import rr16 from "../Images/streetfighter6/Rectangle 16.png";
import rr17 from "../Images/streetfighter6/Rectangle 17.png";
import rr18 from "../Images/streetfighter6/Rectangle 18.png";
      ...
      <div>
        ...
        <div className="relative">
          ...
          <div className="absolute top-0 inset-0 flex items-center justify-center flex-col">
            <a
              href="https://www.youtube.com/watch?v=HE0cMFHN4jo"
              target="_blank"
            >
              <img src={play} alt="" />
            </a>
        ...
        <div className="flex justify-between mx-auto w-max mt-[50px] mb-[30px]">
          ...
          <div className="text-white  mr-[300px]">
            <h1 className="text-[54px] font-bold">Street Fighter 6</h1>
            <div className="flex">
            ...
            <h1 className="font-light text-[18px] mt-[20px]">
              Street Fighter V is a fighting game developed by Capcom and <br />
              released in 2016 for PlayStation 4 and PC.
            </h1>

            <div className="flex gap-[50px] my-[20px]">
              <div className="flex-col">
                <h1>Release date</h1>
                <h1>16 Febuari 2016</h1>
              </div>
              <div className="flex-col">
                <h1>System Requirements</h1>
                <a
                  className="underline hover:underline-offset-4"
                  href="https://store.steampowered.com/app/310950/Street_Fighter_V/"
                  target="_blank"
                >
                  PC
                </a>
