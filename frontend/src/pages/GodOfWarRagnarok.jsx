...
import ps from "../Images/ListGames/ps.png";
import ff3 from "../Images/gow/Rectangle 6.png";
import rr16 from "../Images/gow/Rectangle 16.png";
import rr17 from "../Images/gow/Rectangle 17.png";
import rr18 from "../Images/gow/Rectangle 18.png";
      ...
      <div>
        ...
        <div className="relative">
          ...
          <div className="absolute top-0 inset-0 flex items-center justify-center flex-col">
            <a
              href="https://www.youtube.com/watch?v=ixllGOX0Evw"
              target="_blank"
            >
              <img src={play} alt="" />
            </a>
        ...
        <div className="flex justify-between mx-auto w-max mt-[50px] mb-[30px]">
          ...
          <div className="text-white  mr-[200px]">
            <h1 className="text-[54px] font-bold">God Of War Ragnarok</h1>
            <div className="flex">
            ...
            <h1 className="font-light text-[18px] mt-[20px]">
              God of war ragnarok was the fifth series on God of war frenchise{" "}
              <br />
              that take place after God of war 4, on the other mythology, Norse,{" "}
              <br />
            ...
            <div className="flex gap-[50px] my-[20px]">
              <div className="flex-col">
                <h1>Release date</h1>
                <h1>9 November 2022</h1>
              </div>
              <div className="flex-col">
                <h1>System Requirements</h1>
                <a
                  className="underline hover:underline-offset-4"
                  href="https://www.playstation.com/en-id/games/god-of-war-ragnarok/"
                  target="_blank"
                >
                  PC
                </a>
